...
\draw [loosely dashed] (v9) edge (v3);
\draw [loosely dashed] (v6) edge (v9);
\draw [very thick] (-8.5,-14) ellipse (2 and 2);
\draw [very thick] (-6.5,-10.5) ellipse (2 and 1);
\draw [very thick] (-3,-12.5) ellipse (1.5 and 2);
\draw [very thick] (-5.5,-13.5) ellipse (1.5 and 2);
